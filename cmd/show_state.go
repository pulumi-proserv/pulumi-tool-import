...
Examples:
  ...
  pulumi plugin run import -- show-state --project-dir /path/to/terraform/project

  # Load from a specific workspace
  pulumi plugin run import -- show-state --project-dir /path/to/terraform/project --workspace dev
`,
