...
// Package aws contains import-ID behavior for Pulumi AWS v6 (Terraform AWS v5).
package aws
...
// Load returns a fresh catalog so overrides cannot mutate the embedded defaults.
