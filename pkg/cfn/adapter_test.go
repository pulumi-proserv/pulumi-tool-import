...
func TestCfnGetter_FunctionArnNormalized(t *testing.T) {
	...
	get := CfnGetter(map[string]interface{}{
		"FunctionName": "arn:aws:lambda:us-east-1:123456789012:function:my-service-auth-lambda",
	})
	require.Equal(t, "my-service-auth-lambda", get(importid.RoleFunction))

	// A qualified ARN (…:function:NAME:VERSION) still yields the bare name.
	getQ := CfnGetter(map[string]interface{}{
		"FunctionName": "arn:aws:lambda:us-east-1:123456789012:function:my-fn:PROD",
	})
