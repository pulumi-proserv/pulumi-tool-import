...
// emits, verified against the pinned pulumi/pkg source; see
// BuildRefreshReport's doc for the op vocabulary it encodes.
...
// resource from state when Read reports it gone.
