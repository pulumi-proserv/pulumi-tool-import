...
This tool began as a fork of
[`pulumi/pulumi-tool-terraform-migrate`](https://github.com/pulumi/pulumi-tool-terraform-migrate)
(Apache-2.0) and has since diverged substantially — the import-assistance command
set and the CloudFormation/CDK front-end are additions, and the upstream `stack`
state-translation command has been removed. See [`NOTICE`](./NOTICE).
